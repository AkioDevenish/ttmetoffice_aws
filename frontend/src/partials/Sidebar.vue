      ...
      <div class="space-y-8">
        ...
        <div>
          ...
          <ul class="mt-3">
            ...
            <SidebarLinkGroup
              :active-condition="
                $route.path === '/' || $route.path.includes('dashboard')
              "
            >
                ...
                <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                  <ul class="pl-8 mt-1" :class="{ hidden: !open }">
                    ...
                    <li class="mb-1 last:mb-0">
                      <router-link
                        to="/atmos"
                        class="block text-gray-800 dark:text-gray-100 hover:text-gray-900 dark:hover:text-white truncate transition duration-150"
                      >
                        <div class="flex items-center">
                          <svg
