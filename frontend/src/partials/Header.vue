<template>
  <header :class="[
    ...
    { 'dark:before:bg-gray-800': variant === 'v2' },
    { 'dark:before:bg-gray-900': variant === 'v3' }
  ]">
    <div class="px-4 sm:px-6 lg:px-8">
      <div :class="[
        'flex items-center justify-between h-16',
        { 'lg:border-b border-gray-200 dark:border-gray-700/60': variant !== 'v2' && variant !== 'v3' }
      ]">
        <!-- Header: Left side -->
        <div class="flex">
          <!-- Hamburger button -->
          <button
            ...
            @click.stop="$emit('update:sidebarOpen', !sidebarOpen)"
          >
          ...
          <div>
            <button
              :class="[
                ...
                { 'bg-gray-200 dark:bg-gray-800': searchModalOpen }
              ]"
            ...
            <SearchModal 
              ...
              @update:modalOpen="searchModalOpen = $event" 
            />
          </div>
