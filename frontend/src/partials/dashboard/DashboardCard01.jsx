      ...
      data: {
        ...
        datasets: [
          // Indigo line
          {
            ...
            fill: true,
            backgroundColor: (context) => chartAreaGradient(context.chart.ctx, context.chart.chartArea, [
    ...
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
      <div className="px-5 pt-5">
        ...
        <div className="flex items-start">
          ...
          <div className="text-sm font-semibold text-white px-1.5 bg-green-500 rounded-full" ref={chartDeviation}>0%</div>
        </div>
      </div>
      <div className="grow">
