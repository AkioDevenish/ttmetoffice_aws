<template>
  <div class="flex flex-col col-span-full sm:col-span-6 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
    ...
    <div v-else-if="!processedData.datasets[0].data.length" class="text-center text-gray-500 p-4">No data available for UWI station</div>
    <div v-else>
      <RealtimeChart 
        :data="processedData" 
        :width="595" 
